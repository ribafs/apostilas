...
- Veja que não mais existe um index.php no raiz. Quando alguém chega no raiz é redirecionado para a apsta public pelo .htaccess
...
- Então inclui a classe Core/Application através do use
